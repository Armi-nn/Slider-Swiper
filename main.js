        ...
        a !== void 0 &&
          ...
          ($(t[o]) && $(s[o])
            ? s[o].__swiper__
              ...
              : G(t[o], s[o])
            : !$(t[o]) && $(s[o])
            ? ((t[o] = {}), s[o].__swiper__ ? (t[o] = s[o]) : G(t[o], s[o]))
            : (t[o] = s[o]));
      }
    }
  }
...
function Ne() {
  ...
  typeof S == "string" && S.indexOf("%") >= 0
    ...
    i.centeredSlides &&
      i.cssMode &&
      (H(s, "--swiper-centered-offset-before", ""),
  ...
  const A =
    ...
    Object.keys(i.breakpoints).filter(
      (w) => typeof i.breakpoints[w].slidesPerView < "u"
    ).length > 0;
  for (let w = 0; w < f; w += 1) {
    C = 0;
    let T;
  ...
  if (
    ...
    i.setWrapperSize &&
      (s.style[t.getDirectionLabel("width")] = `${t.virtualSize + S}px`),
  ...
  if (
    ...
    f <= i.maxBackfaceHiddenSlides
      ? T || t.el.classList.add(w)
      : T && t.el.classList.remove(w);
  }
}
function Be(t) {
  const e = this,
  ...
  if (
    ...
    if (e === 0) o[f ? "scrollLeft" : "scrollTop"] = -c;
      ...
      if (!r.support.smoothScroll)
        return (
          me({ swiper: r, targetPosition: -c, side: f ? "left" : "top" }), !0
        );
...
function tt(t, e) {
  ...
  s.cssMode ||
    ...
    ge({ swiper: i, runCallbacks: t, direction: e, step: "Start" }));
}
function it(t, e) {
  t === void 0 && (t = !0);
  const i = this,
  ...
  (i.animating = !1),
    !s.cssMode &&
      (i.setTransition(0),
      ge({ swiper: i, runCallbacks: t, direction: e, step: "End" }));
}
...
function rt(t, e, i, s, n) {
  ...
  if (
    ...
    return (
      ...
      E !== "reset" && (r.transitionStart(i, E), r.transitionEnd(i, E)),
      !1
    );
  if (o.cssMode) {
    ...
    if (e === 0) {
      ...
      if (!r.support.smoothScroll)
        return (
          me({ swiper: r, targetPosition: h, side: S ? "left" : "top" }), !0
        );
      u.scrollTo({ [S ? "left" : "top"]: h, behavior: "smooth" });
    }
    return !0;
  }
  return (
    ...
    (r = parseInt(t.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
      e.centeredSlides
        ? n < t.loopedSlides - s / 2 ||
          ...
          ? (t.loopFix(),
            (n = t.getSlideIndex(
              V(i, `${l}[data-swiper-slide-index="${r}"]`)[0]
            )),
            ee(() => {
              t.slideTo(n);
            }))
...
function ut(t) {
  ...
  const n = () => {
    ...
    d = (c) => {
      for (let f = 0; f < c; f += 1) {
        const p = e.isElement
          ? te("swiper-slide", [i.slideBlankClass])
          : te("div", [i.slideClass, i.slideBlankClass]);
        e.slidesEl.append(p);
      }
    };
  if (o) {
...
function pt(t) {
  ...
  v === "auto"
    ...
    : ((v = Math.ceil(parseFloat(u.slidesPerView, 10))),
      m && v % 2 === 0 && (v = v + 1));
  ...
  typeof r > "u"
    ? (r = a.getSlideIndex(
        d.filter((b) => b.classList.contains(u.slideActiveClass))[0]
      ))
    : (x = r);
  const I = s === "next" || !s,
    M = s === "prev" || !s;
  ...
  const w = E ? Math.ceil(d.length / u.grid.rows) : d.length,
    P = (E ? d[r].column : r) + (m && typeof n > "u" ? -v / 2 + 0.5 : 0);
  if (P < g) {
    C = Math.max(g - P, y);
...
function xt(t) {
  ...
  if (typeof s.isScrolling > "u") {
    ...
    (i.isVertical() && r.currentX === r.startX)
      ? (s.isScrolling = !1)
      : p * p + u * u >= 25 &&
        ((I = (Math.atan2(Math.abs(u), Math.abs(p)) * 180) / Math.PI),
  ...
  if (!s.isMoved) {
    if (
      (g && E && i.loopFix({ direction: i.swipeDirection }),
        ...
        s.currentTranslate > i.minTranslate() &&
          ...
          n.resistance &&
            (s.currentTranslate =
              i.minTranslate() -
              1 +
              (-i.minTranslate() + s.startTranslate + m) ** x)))
      : m < 0 &&
        (g &&
          E &&
          !S &&
        ...
        s.currentTranslate < i.maxTranslate() &&
          ...
          n.resistance &&
            (s.currentTranslate =
              i.maxTranslate() +
              1 -
              (i.maxTranslate() - s.startTranslate - m) ** x))),
...
function yt(t) {
  ...
  if (s.type === "touchend" || s.type === "touchcancel") {
    if (
      ((n = [...s.changedTouches].filter((x) => x.identifier === i.touchId)[0]),
  ...
  for (
    ...
    typeof d[x + I] < "u"
      ? (m || (u >= d[x] && u < d[x + I])) && ((v = x), (y = d[x + I] - d[x]))
      : (m || u >= d[x]) && ((v = x), (y = d[d.length - 1] - d[d.length - 2]));
  }
  let g = null,
    E = null;
  l.rewind &&
  ...
  if (p > l.longSwipesMs) {
    ...
    e.swipeDirection === "next" &&
      (S >= l.longSwipesRatio
        ? e.slideTo(l.rewind && e.isEnd ? g : v + h)
        : e.slideTo(v)),
      e.swipeDirection === "prev" &&
        (S > 1 - l.longSwipesRatio
          ? e.slideTo(v + h)
          : E !== null && S < 0 && Math.abs(S) > l.longSwipesRatio
          ? e.slideTo(E)
          : e.slideTo(v));
  } else {
    if (!l.shortSwipes) {
    ...
    (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl)
      ? s.target === e.navigation.nextEl
        ? e.slideTo(v + h)
        : e.slideTo(v)
      : (e.swipeDirection === "next" && e.slideTo(g !== null ? g : v + h),
...
var Vt = { addClasses: kt, removeClasses: Dt };
function Ft() {
  const t = this,
...
function $t({ swiper: t, on: e, extendParams: i }) {
  ...
  const s = () => {
      const { slides: r, slidesSizesGrid: l, params: o, size: a } = t,
        ...
        u = p
          ? 0.5
          : Math.min(Math.max(o.materialEffect.slideSplitRatio, 0), 1),
        m = p
          ? 0.5
          : 1 - Math.min(Math.max(o.materialEffect.slideSplitRatio, 0), 1);
      for (let v = 0; v < r.length; v += 1) {
        ...
        if (d === 1)
          h > 0 && ((M = 1 - h), (C = -x + a * Math.min(h, 1)), (A = M ** 4));
        else {
          if (
            (h > 0 && h <= d - 2 && ((C = I), (M = 1), (A = 1)),
        ...
        M < 0 && (M = 0),
          ...
          t.isHorizontal()
            ? ((g.style.width = `${100 * M}%`),
              (g.style.transform = `translate3d(${C - P}px, 0, 0)`))
            : ((g.style.height = `${100 * M}%`),
...
Ht.addEventListener("change", (t) => {
  ...
  (Y.params.centeredSlides = e), Y.update();
});
